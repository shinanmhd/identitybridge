...
function makeTestGuard(): object
{
    return new class implements \Illuminate\Contracts\Auth\Guard
    {
        ...
        public function check(): bool { return $this->storedUser !== null; }
        public function guest(): bool { return ! $this->check(); }
        public function user(): ?Authenticatable { return $this->storedUser; }
        public function id(): mixed { return $this->storedUser?->getAuthIdentifier(); }
        public function validate(array $credentials = []): bool { return false; }
        public function hasUser(): bool { return $this->storedUser !== null; }
